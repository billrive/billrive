...
DROP SCHEMA IF EXISTS `billrive` ;
...
DROP TABLE IF EXISTS `billrive`.`billfinances` ;
...
DROP TABLE IF EXISTS `billrive`.`user` ;
...
DROP TABLE IF EXISTS `billrive`.`bill` ;
...
DROP TABLE IF EXISTS `billrive`.`billitementry` ;
...
DROP TABLE IF EXISTS `billrive`.`useridandliablecost` ;
