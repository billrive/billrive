...
INSERT INTO `billsimpleentry` VALUES (1,'simple',NULL,2),(2,'simple',NULL,4);
...
CREATE TABLE `simpleuseridandliablecost` (
  ...
  PRIMARY KEY (`id`,`userId`,`billSimpleEntryId`),
  UNIQUE KEY `id_UNIQUE` (`id`),
...
INSERT INTO `simpleuseridandliablecost` VALUES (1,6,10,1),(2,7,10,1),(3,8,10,1);
...
-- Dump completed on 2013-08-13 19:00:09
